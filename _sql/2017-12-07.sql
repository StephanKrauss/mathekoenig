...
CREATE TABLE `benutzer` (
  ...
  `schatz` mediumint(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `adel_id` (`adel_id`),
...
insert  into `benutzer`(`id`,`benutzername`,`adel_id`,`passwort`,`geschlecht`,`alias`,`schatz`) values (1,'Stephan123',7,'Polygon123','1','ABCDEF',1000),(2,'Mustermann',5,'Mustermann','2',NULL,900),(3,'Hülsensack',6,'Hülsensack','1',NULL,800),(4,'Pumpelhuber',4,'Pumpelhuber','1',NULL,700),(5,'Kneipel',18,'Kneipel','1',NULL,600);
